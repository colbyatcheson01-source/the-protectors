            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="card">
                  ...
                  <p className="text-neutral-500 text-sm font-mono">
                    Club Enlistment: <span className="text-biker-flame">TheEnforcersSC@gmail.com</span> <span className="text-xs text-neutral-600">| the subject line of the email: Enlistment</span>
                  </p>
                </div>
                <div className="card">
